								...
								<div class="col-lg-6 col-xl-6">
									<div class="login-sec">
										<div class=" text-center card mb-0">
											<form id="login" class="card-body" tabindex="500" action="{{URL('dashboard/SaveAdminRegister')}}" method="post">
                                            {{ csrf_field() }}
					                  	<fieldset>
                                                                        <h4 class="mb-3">Register</h4>
												<div class="">
													<div class="form-group">
														<input  class="form-control @if($errors->has('nname')) border-danger @endif"  name="nname" placeholder="type the name ...">
                                                  
                                                         <!-- error validations-->
										  @if($errors->has('nname')) 
                                            <span style="color:red">
                                            <!--    <input class="text-danger" > --> <small> {{ $errors->first('nname') }} </small>
                                            </span>
                                            @endif
                                                    </div>
                                        ...
                                        <button class="btn btn-primary waves-effect width-md waves-light" type="submit"> Register Now </button>
                                    </div>
												<p class="mb-2"><a href="forgot.html">Forgot Password</a></p>
												<p class="text-dark mb-0">Don't have account?<a href="{{URL('dashboard/login')}}" class="text-primary ml-1">login</a></p>
										    </form>
